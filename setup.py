...
if __name__ == '__main__':
    ...
    setup(
        ...
        ext_modules=[
            make_cuda_ext(
                name='voxelize_ext',
                module='mmdet3d.ops.voxelize',
                sources=[
                    'src/voxelize_cuda.cu',
                    'src/voxelize.cpp'
                ],
                extra_include_path=[
                    os.path.join(project_root, 'mmdet3d/ops/common')
                ]
            ),
            make_cuda_ext(
            ...
            make_cuda_ext(
                ...
                module='mmdet3d.ops.ms_deform_attn',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='mmdet3d.ops.points_in_boxes',
                sources=[
            ...
            make_cuda_ext(
                name='msmv_sampling_ext',
                module='mmdet3d.ops.msmv_sampling',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='mmdet3d.ops.deformable_aggregation',
                sources=[
