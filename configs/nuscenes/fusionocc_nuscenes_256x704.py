...
base_metas = ['ori_img', 'scene_token', 'scene_name', 'frame_idx', 'prev_exists', \
              'intrinsic', 'cam2ego', 'post_trans', 'bda', 'ego_pose', 'ego_pose_inv', 'timestamp']
...
train_pipeline = [
    ...
    dict(
        ...
        load_dim=5,
        use_dim=5),
    dict(type='LoadOccupancy', ignore_nonvisible=False, occupancy_path=occupancy_path),
...
val_evaluator = dict(type='RayMetric', use_image_mask=False)
