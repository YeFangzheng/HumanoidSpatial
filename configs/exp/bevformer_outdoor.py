...
train_pipeline = [
    ...
    dict(type='Pack3DDetInputs', keys=['img', 'gt_occupancy'], meta_keys=[] + base_metas)
]
...
test_pipeline = [
    ...
    dict(type='Pack3DDetInputs', keys=['img', 'gt_occupancy'], meta_keys=['lidar_origins', 'visible_mask'] + base_metas)
]
