...
data_config = {
    'cams': [
        'CAM_FRONT', 'CAM_FRONT_LEFT', 'CAM_BACK_LEFT', 'CAM_BACK', 
        'CAM_BACK_RIGHT', 'CAM_FRONT_RIGHT', 
    ],
    'Ncams': 6,
    'input_size': (768, 960),
    'src_size': (1536, 1920),
...
model = dict(
    ...
    model=dict(
        ...
        pts_middle_encoder=dict(
            type='PointPillarsScatterONNX', in_channels=64, output_shape=(bev_h_, bev_w_)), # NOTE
        pts_backbone=dict(
            type='SECOND',
            in_channels=64,
...
occupancy_path = 'data/humanoid/industry/annotation/occ'
