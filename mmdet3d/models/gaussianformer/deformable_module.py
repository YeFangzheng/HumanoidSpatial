...
from .safe_ops import safe_sigmoid
from .utils import get_rotation_matrix, linear_relu_ln
try:
    from mmdet3d.ops.deformable_aggregation import DeformableAggregationFunction as DAF
except:
    DAF = None
        ...
        **kwargs: dict,
        ...
        for (
            ...
            if self.use_deformable_func:
                ...
                projection_mat = torch.stack([meta['projection_mat'] for meta in metas]).to(instance_feature.device)
