...
from mmdet3d.ops.voxelize import VoxelizationByGridShape, dynamic_scatter_3d
    ...
    def voxelize(self, points: List[Tensor],
        ...
        if self.voxel_type == 'hard':
            ...
            for i, res in enumerate(points):
                ...
                res_voxel_centers = (res_coors[:, [2, 1, 0]] + 0.5) * self.voxel_layer.voxel_size.to(res_voxels.device) + \
                        self.voxel_layer.point_cloud_range[0:3].to(res_voxels.device)
