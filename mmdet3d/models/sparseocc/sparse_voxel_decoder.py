...
class SparseVoxelDecoder(BaseModule):
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        for i, layer in enumerate(self.decoder_layers):
            ...
            # bbox from coords
            query_bbox = index2point(query_coord, self.pc_range, voxel_size=0.1)  # [B, N, 3]
            query_bbox = point2bbox(query_bbox, box_size=0.1 * interval)  # [B, N, 6]
