...
from mmdet3d.models.fusionocc import MSDeformableAttention3D


@MODELS.register_module()
class SurroundOccPerceptionTransformer(BaseModule):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(SurroundOccPerceptionTransformer, self).__init__(**kwargs)
