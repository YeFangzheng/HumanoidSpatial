...
class BEVDetOcc(MVXTwoStageDetector):
    ...
    def extract_img_feat(self, imgs, img_metas):
        ...
        return bev_feat, depth, img_feat

    def extract_bev_feat(self, img, img_metas):
        bev_feat, depth, mlvl_feats = self.extract_img_feat(img, img_metas)
        return bev_feat, depth, mlvl_feats
    ...
    def extract_feat(self, inputs, img_metas):
        ...
        curr_bev_feat, depth, _ = self.extract_bev_feat(imgs, img_metas)
