...
def points_in_boxes_part(points: Tensor, boxes: Tensor) -> Tensor:
    ...
    points_in_boxes_ext.points_in_boxes_part_forward(boxes.contiguous(),
                                                     points.contiguous(),
                                                     box_idxs_of_pts)
...
def points_in_boxes_cpu(points: Tensor, boxes: Tensor) -> Tensor:
    ...
    for b in range(batch_size):
        points_in_boxes_ext.points_in_boxes_cpu_forward(boxes[b].float().contiguous(),
...
def points_in_boxes_all(points: Tensor, boxes: Tensor) -> Tensor:
    ...
    points_in_boxes_ext.points_in_boxes_all_forward(boxes.contiguous(),
                                                    points.contiguous(),
                                                    box_idxs_of_pts)
